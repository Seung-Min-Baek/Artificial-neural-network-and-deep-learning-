...
model = load_model('X_rayQ3_512V3bf.h5')
...
plot_loss(history)
plt.savefig('X_rayQ3_512V3af.loss.png')
plt.clf()
plot_acc(history)
plt.savefig('X_rayQ3_512V3af.accuracy.png')
...
print("matrix(Q3 512 V3 af) :", matrix)
print("auc:", auc)
